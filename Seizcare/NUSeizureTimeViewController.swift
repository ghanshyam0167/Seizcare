//
//  NUSeizureTimeViewController.swift
//  Seizcare
//
...
class NUSeizureTimeViewController: UIViewController {
    ...
    private var rowControls: [NUTimeRowView] = []
    ...
    private func setupViews() {
        ...
        headerLabel.text = "At what time do you commonly experience seizures?"
        ...
        for i in 0..<options.count {
            let row = NUTimeRowView(title: options[i])
            row.tag = i
    ...
    @objc private func rowTapped(_ sender: NUTimeRowView) {
    ...
    @objc private func continueButtonTapped() {
        ...
        // Save selection
        UserDefaults.standard.set(options[index].lowercased(), forKey: "commonSeizureTime")

        // Navigate to Seizure Frequency screen
        let freqVC = storyboard?.instantiateViewController(withIdentifier: "NUSeizureFrequencyVC") as! NUSeizureFrequencyViewController
        navigationController?.pushViewController(freqVC, animated: true)
    }
...
private class NUTimeRowView: UIControl {
