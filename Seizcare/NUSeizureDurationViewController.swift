//
//  NUSeizureDurationViewController.swift
//  Seizcare
//
...
class NUSeizureDurationViewController: UIViewController {
    ...
    private var rowControls: [NUDurationRowView] = []
    ...
    private func setupViews() {
        ...
        headerLabel.text = "How long does your typical seizure last?"
        ...
        for i in 0..<options.count {
            let row = NUDurationRowView(title: options[i])
            row.tag = i
    ...
    @objc private func rowTapped(_ sender: NUDurationRowView) {
    ...
    @objc private func continueButtonTapped() {
        ...
        // Save selection
        UserDefaults.standard.set(options[index], forKey: "typicalSeizureDuration")

        // Navigate to Sleep Hours screen
        let sleepVC = storyboard?.instantiateViewController(withIdentifier: "NUSleepHoursVC") as! NUSleepHoursViewController
...
// MARK: - NUDurationRowView

private class NUDurationRowView: UIControl {
